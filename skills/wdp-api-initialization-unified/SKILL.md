...
2. ✅ **必须采用 npm 工程化基线**。所有的新工程必须包含 `package.json`，且显式声明 `"wdpapi": "^2.3.1"` 依赖。
...
| `BimApi is not defined` | 插件未安装或未导入 | `npm install @wdp-api/bim-api@^2.2.1` 并确认 import |
