...
```json
{
  "activeContext": {
    "layer": "system",
    "summary": "当前任务：实现BIM高亮... | 必须真值：official-bim-full.md",
    "data": {
      "matchedSkills": ["wdp-api-bim-unified/SKILL.md"],
      "requiredOfficialFiles": ["official_api_code_example/official-bim-full.md"],
      "skillsSnapshot": [...],
      "officialIndex": [...]
    },
...
- 处理大体量数据（如 `scene-discovery` 发现的上百个实体快照）
